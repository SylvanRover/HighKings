...
public partial class TouchKit : MonoBehaviour
{
	...
	[HideInInspector]
	public bool simulatePinchWithScrollwheel = true;
	[HideInInspector]
	...
	private void internalUpdateTouches()
	{
		...
		if( shouldProcessMouseInput() )
		{
			...
			#if UNITY_EDITOR || UNITY_WEBPLAYER || UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_WEBPLAYER || UNITY_WEBGL
	...
	public static void removeGestureRecognizer( TKAbstractGestureRecognizer recognizer )
	{
		...
		{
			Debug.LogWarning( "Trying to remove gesture recognizer that has not been added: " + recognizer );
			return;
		}
